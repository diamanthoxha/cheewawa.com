...
<div class="credits-list">
    ...
    <div class="card credit">
        ...
        <p>The site is delivered through <b>Cloudflare</b>, which may set a small technical cookie
           (such as <code>__cf_bm</code>) to tell humans apart from bots. It exists for security,
           expires quickly, and identifies nobody.</p>
    </div>
    <div class="card credit">
        <h3><?= chi_paw(18) ?> Managing cookies</h3>
        <p>Every modern browser lets you block or delete cookies in its settings. Blocking cookies
           will not break anything here.</p>
    </div>
    <div class="card credit">
