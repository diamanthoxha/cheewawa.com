...
<div class="credits-list">
    ...
    <div class="card credit">
        ...
        <p><b>Contact form:</b> your name, email address, and message. We store them in our database
           and use them for one thing only: replying to you.</p>
        <p><b>Newsletter:</b> your email address, stored until you unsubscribe. No tracking pixels,
           no profiling, no passing it on.</p>
        <p><b>Server logs:</b> like almost every website, our server keeps standard access logs
           (IP address, browser type, pages requested). We use them for security and debugging,
           and they rotate out automatically.</p>
    </div>
    <div class="card credit">
